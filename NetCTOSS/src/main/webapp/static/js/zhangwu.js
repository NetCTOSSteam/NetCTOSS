...
$(function () {
    $('#tt').datagrid({
        url:'',
        columns:[[
            {field:'a',title:'姓名',width:12,align:'center'},
            {field:'b',title:'账务帐号',width:12,align:'center'},
            {field:'d',title:'身份证号码',width:12,align:'center'},
            {field:'c',title:'联系电话',width:12,align:'center'},
            {field:'e',title:'通讯地址',width:12,align:'center'}
        ]],
        toolbar:'#tb'
    });
    $('#cc').combobox({
